...
import DevelopmentalBiologyGastrulationCanonicalLaneLean.BridgeLemmas
...
theorem constrained_gastrulation_endgame (A : AdmissibleClass) : ConstrainedGastrulationClosure A := by
